...
for editing variables. This will ensure the configuration you provide
matches the schema specified by the developer, and thus prevents you
from misconfiguring stuff.
#+END_QUOTE
...
#+BEGIN_QUOTE
NOTE: This will cause an indistinction between sentences and name
abbrieviations (eg. E. B. White)
#+END_QUOTE
...
#+end_src
** Paradox
Use Paradox instead of the default =package-list-packages=.
#+begin_src emacs-lisp :tangle yes
  (use-package paradox
