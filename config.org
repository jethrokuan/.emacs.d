...
** Go
   #+begin_src emacs-lisp 
     ...
     (defvar jethro/golint-path "" "Path to golint binary.")
...
#+BEGIN_SRC emacs-lisp 
  ...
  (defvar jethro/merlin-site-elisp nil "Site lisp directory for Merlin.")
  (defvar jethro/utop-site-elisp  nil "Site lisp directory for utop.")
  (defvar jethro/ocp-site-elisp nil "Site lisp directory for ocp-indent.")
  (defvar jethro/dune-site-elisp nil "Site lisp directory for dune.")
