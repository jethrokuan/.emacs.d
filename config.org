...
#+BEGIN_SRC emacs-lisp :tangle yes
  (use-package org-gcal
    ...
    (setq org-gcal-client-id jethro/org-gcal-client-id
          ...
          org-gcal-file-alist `(("jethrokuan95@gmail.com" . ,(concat (file-name-as-directory jethro/org-gcal-directory) "personal.org"))
                                ("62ad47vpojb2uqb53hpnqsuv5o@group.calendar.google.com" . ,(concat (file-name-as-directory jethro/org-gcal-directory) "school.org"))
                                ("wing.nus@gmail.com" . ,(concat (file-name-as-directory jethro/org-gcal-directory) "wing.org"))
                                ("linuxnus.org_f1e8c6kcuuj0k1elmhh9vboo5c@group.calendar.google.com" . ,(concat (file-name-as-directory jethro/org-gcal-directory) "nushackers.org")))))
#+END_SRC
** Org Mode for GTD
